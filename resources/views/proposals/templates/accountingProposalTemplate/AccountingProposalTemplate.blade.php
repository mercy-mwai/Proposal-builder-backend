...
<body class="doc-content">
    <!-- Restructured with modern hero section -->
    <div class="hero-section">
        ...
        <div class="hero-meta">
            ...
            <p>{company_address_1} | {company_city}, {company_state} | {company_zip_code} | {company_url}</p>
        </div>
    </div>
    ...
    <div class="section-card">
        ...
        <p>{company_name} is pleased to present this proposal to provide professional accounting, consulting and
            financial management services to {client_name}. Our experience in providing (INSERT INDUSTRY, ie. medical,
            small-business, etc) accounting services in {client_province} over the last # years, provides us with a
            solid understanding of your business environment and needs.</p>
        <p>We have over # of clients that work in the INDUSTRY. This represents #% of the business completed by
            {company_name}. We are active members in the INDUSTRY community and believe that we can provide
            {client_name} with outstanding expert service that is unmatched by other accounting companies.</p>
        <p>We have developed this package that follows with {client_name} in mind, providing information that is most
            relevant to your current business needs.</p>
        <p>If you are interested in any additional information, do not hesitate to contact us. We look forward to
            serving you.</p>
        <p>Sincerely,</p>
    ...
    <div class="section-card">
        <h1>About Us</h1>
        <p class="accent-text font-semibold">With more than x years of service, {company_name} is focused on providing
            our clients advice on taxation, accounting and consulting services that reflect their needs. {company_name}
            has been located in the {company_city} area, providing our accounting, tax and consulting services focused
            on [industry 1], [industry 2], and [industry 3].</p>
        <p>Our team has X people dedicated to our PROPOSED CLIENT INDUSTRY, with an additional # people supporting them
            in the practice. Our team of consultants provides strategic support for your planning, marketing assessment,
            facility planning, capital planning, operational needs and leadership needs.</p>
        <p>We pride ourselves on being experts in the INSERT INDUSTRY, offering insight that stems beyond accounting and
            can help guide strategy and operations in your company – helping you to manage revenues, build market share
    ...
    <!-- Team section with enhanced presentation -->
    {{-- <div class="section-card">
        <h1>Team</h1>
        <p class="accent-text font-semibold">As our client your engagement would be led by a single partner, {user_assigned}. {user_assigned} is backed by a team of dedicated and seasoned professionals, who have a combined # years experience in INSERT INDUSTRY.</p>
        
        <h2>James McIntyre</h2>
        <h3>CPA, Team Lead</h3>
        <p>James has over 20 years experience with INDUSTRY finance and operations, working with INDUSTRY EXAMPLE ORGANIZATIONS. He has consulted on a wide variety of financial management and operation issues including:</p>
        <ul>
        ...
        <h4>PROFESSIONAL / CIVIC ORGANIZATIONS</h4>
        <ul>
    ...
    <div class="section-card"
        ...
        <p class="accent-text font-semibold" style="margin-bottom: 2rem;">
            ...
            {user_assigned} is backed by a team of dedicated and seasoned professionals, who have a combined # years
        ...
        <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 2rem; align-items: start;">
            ...
            <div>
                ...
                <h4 style="margin-top: 1.5rem; font-weight: bold; color: #006377;">Professional / Civic Organizations
                </h4>
                <ul style="margin-left: 1.25rem; list-style: disc;">
                    <li>Member of the American Institute of CPAs</li>
                    <li>INDUSTRY association</li>
    ...
    <!-- Project Summary with visual improvements -->
    <div class="section-card">
        <h1>Project Summary</h1>
        <p class="accent-text font-semibold">{client_name} is interested in securing an accounting partner to assist
        ...
        <img src="{{ asset('storage/images/image3.jpg') }}" 
             alt="Project Illustration"
             style="max-width: 100%; height: auto; border-radius: 0.5rem;">
    </div>
    </div>

    <!-- Proposal section with structured layout -->
    <div class="section-card">
        <h1>Proposal</h1>
        <p class="accent-text font-semibold">{company_name} will help {client_name} move to a comprehensive transaction
            management service built on the QuickBooks platform. This move will allow for all bookkeeping and accounting
            functions to be seamlessly accessible as well as provide complete customer data access.</p>
        <p>{company_name} proposes to host and maintain all the QuickBooks data files, so that actually licensing costs
            are built into Expert Accountants weekly service fee so that there is no software investment required.
    ...
    <div class="section-card">
        ...
        <p class="accent-text font-semibold">Our fees are based on the time required and will be billed at the
            all-inclusive fixed rate of $150.00 per hour for the contract period of one year from the date of the
            contract.</p>
        <p>Expenses for travel, meals, lodging, printing and report production are charged as part of the all-inclusive
            rate above. We are sensitive to the financial challenges facing INDUSTRY and want to minimize fees to the
        ...
        <p>We are proposing to provide the following services within these fee hours: preparation of audited tax
            statements, filing of state and federal taxes, review of bookkeeping procedure, consulting on financial
            business practices and reporting to business partners as directed.</p>
        <p>We are also providing outsourced bookkeeping and CFO services. This will not only reduce/eliminate personnel
            and related costs required for current in-house processes, but also add much needed financial reporting
            detail and cash management.</p>

        <h2>Cost Comparison</h2>
        <div class="highlight-box">
            <p><strong>One full time clerical staff, 40 hrs/week, $12/hr, payroll taxes: $542.00/week</strong></p>
    ...
    <div class="section-card">
        ...
        <p>During this phase, our collective teams will meet to review overall project goals, establish metrics to
            monitor achievement of objects. We will map out current accounting processes, review annual tax preparation
            requirements and determine specific accounting responsibilities of your company and of Accounting Experts to
        ...
        <ul>
            <li>Customer, vendors, beginning balances, general ledger month-end balances for 12 months prior</li>
        ...
        <img src="{{ asset('storage/images/image2.jpg') }}" 
             alt="Project Illustration"
             style="max-width: 100%; height: auto; border-radius: 0.5rem;">
    </div>
    </div>
    ...
    <div class="contact-section">
        <h1>Contact</h1>
        <p class="font-semibold">{company_name} are very interested in working with {client_name} and would love to set
            up a meeting with you to answer any questions you may have and determine the next steps in this process.</p>
